...
public class UsuarioDto {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idUsuario, nombreCuentaUsuario, emailUsuario, nombreRealUsuario, paisUsuario, fechaNacUsuario, fechaRegUsuario, avatarUsuario, saldoUsuario, estadoCuentaUsuario);
    }
}
